...
inline interval<T, Policies> hull(const interval<T, Policies> &x,
  ...
  return interval<T, Policies>(
      min BOOST_PREVENT_MACRO_SUBSTITUTION(x.lower(), y.lower()),
...
inline interval<T, Policies> hull(const interval<T, Policies> &x, const T &y) {
  ...
  return interval<T, Policies>(
      min BOOST_PREVENT_MACRO_SUBSTITUTION(x.lower(), y),
...
inline interval<T, Policies> hull(const T &x, const interval<T, Policies> &y) {
  ...
  return interval<T, Policies>(
      min BOOST_PREVENT_MACRO_SUBSTITUTION(x, y.lower()),
...
inline T norm(const interval<T, Policies> &x) {
  ...
  BOOST_USING_STD_MAX();
  return max BOOST_PREVENT_MACRO_SUBSTITUTION(static_cast<T>(-x.lower()),
                                              x.upper());
}
