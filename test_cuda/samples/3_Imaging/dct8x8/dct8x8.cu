...
/**
 *  Texture reference that is passed through this global variable into device
 * code. This is done because any conventional passing through argument list way
 * results in compiler internal error. 2008.03.11
 */
