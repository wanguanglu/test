...
*routines, used in JPEG internal data processing. Device code.
*
...
*The data processing is done using floating point representation. The routine
*that performs quantization of coefficients can be found in
...
*Transform of the given image plane and outputs result to the array of
*coefficients.
*
...
*processing \param OffsetYBlocks  [IN] - Offset along Y in blocks from which to
*perform processing
*
* \return None
*/
...
*Transform of the given DCT coefficients plane and outputs result to the image
*array
*
