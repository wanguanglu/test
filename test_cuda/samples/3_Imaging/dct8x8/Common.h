...
/**
 *  This macro states that __mul24 operation is performed faster that
 * traditional multiplication for two integers on CUDA. Please undefine if it
 * appears to be wrong on your system
 */
