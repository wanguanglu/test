...
public:
  ...
  static void Copy2D(Npp8u *pDst, size_t nDstPitch, const Npp8u *pSrc,
    ...
    cudaError_t eResult;
    eResult =
        cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch, nWidth * sizeof(Npp8u),
                     nHeight, cudaMemcpyDeviceToDevice);
  ...
  static void DeviceToHostCopy2D(Npp8u *pDst, size_t nDstPitch,
    ...
    eResult =
        cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch, nWidth * sizeof(Npp8u),
                     nHeight, cudaMemcpyDeviceToHost);
    NPP_ASSERT(cudaSuccess == eResult);
  };
};
...
public:
  ...
  static void Copy2D(Npp16u *pDst, size_t nDstPitch, const Npp16u *pSrc,
    ...
    cudaError_t eResult;
    eResult =
        cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch, nWidth * sizeof(Npp16u),
                     nHeight, cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
...
public:
  ...
  static void Copy2D(Npp16u *pDst, size_t nDstPitch, const Npp16u *pSrc,
    ...
    cudaError_t eResult;
    eResult = cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch,
                           nWidth * 2 * sizeof(Npp16u), nHeight,
                           cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
...
public:
  ...
  static void Copy2D(Npp16u *pDst, size_t nDstPitch, const Npp16u *pSrc,
    ...
    cudaError_t eResult;
    eResult = cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch,
                           nWidth * 3 * sizeof(Npp16u), nHeight,
                           cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
...
public:
  ...
  static void Copy2D(Npp16u *pDst, size_t nDstPitch, const Npp16u *pSrc,
    ...
    cudaError_t eResult;
    eResult = cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch,
                           nWidth * 4 * sizeof(Npp16u), nHeight,
                           cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
...
public:
  ...
  static void Copy2D(Npp16s *pDst, size_t nDstPitch, const Npp16s *pSrc,
    ...
    cudaError_t eResult;
    eResult =
        cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch, nWidth * sizeof(Npp16s),
                     nHeight, cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
...
public:
  ...
  static void Copy2D(Npp16s *pDst, size_t nDstPitch, const Npp16s *pSrc,
    ...
    cudaError_t eResult;
    eResult = cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch,
                           nWidth * 2 * sizeof(Npp16s), nHeight,
                           cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
...
public:
  ...
  static void Copy2D(Npp16s *pDst, size_t nDstPitch, const Npp16s *pSrc,
    ...
    cudaError_t eResult;
    eResult = cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch,
                           nWidth * 4 * sizeof(Npp16s), nHeight,
                           cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
...
public:
  ...
  static void Copy2D(Npp32s *pDst, size_t nDstPitch, const Npp32s *pSrc,
    ...
    cudaError_t eResult;
    eResult =
        cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch, nWidth * sizeof(Npp32s),
                     nHeight, cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
...
public:
  ...
  static void Copy2D(Npp32s *pDst, size_t nDstPitch, const Npp32s *pSrc,
    ...
    cudaError_t eResult;
    eResult = cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch,
                           nWidth * 3 * sizeof(Npp32s), nHeight,
                           cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
...
public:
  ...
  static void Copy2D(Npp32s *pDst, size_t nDstPitch, const Npp32s *pSrc,
    ...
    cudaError_t eResult;
    eResult = cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch,
                           nWidth * 4 * sizeof(Npp32s), nHeight,
                           cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
...
public:
  ...
  static void Copy2D(Npp32f *pDst, size_t nDstPitch, const Npp32f *pSrc,
    ...
    cudaError_t eResult;
    eResult =
        cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch, nWidth * sizeof(Npp32f),
                     nHeight, cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
...
public:
  ...
  static void Copy2D(Npp32f *pDst, size_t nDstPitch, const Npp32f *pSrc,
    ...
    cudaError_t eResult;
    eResult = cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch,
                           nWidth * 2 * sizeof(Npp32f), nHeight,
                           cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
...
public:
  ...
  static void Copy2D(Npp32f *pDst, size_t nDstPitch, const Npp32f *pSrc,
    ...
    cudaError_t eResult;
    eResult = cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch,
                           nWidth * 3 * sizeof(Npp32f), nHeight,
                           cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
...
public:
  ...
  static void Copy2D(Npp32f *pDst, size_t nDstPitch, const Npp32f *pSrc,
    ...
    cudaError_t eResult;
    eResult = cudaMemcpy2D(pDst, nDstPitch, pSrc, nSrcPitch,
                           nWidth * 4 * sizeof(Npp32f), nHeight,
                           cudaMemcpyDeviceToDevice);
    NPP_ASSERT(cudaSuccess == eResult);
  };
