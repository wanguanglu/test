...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wanguanglu/work/ros_study/2.ros_launch/install/${idir}'.  Ask the maintainer 'wanguanglu <wanguanglu@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/wanguanglu/work/ros_study/2.ros_launch/install/lib;/home/wanguanglu/work/ros_study/1.create_package/devel/lib;/opt/ros/indigo/lib)
