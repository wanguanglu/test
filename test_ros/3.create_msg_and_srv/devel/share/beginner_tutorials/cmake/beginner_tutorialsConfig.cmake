...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/wanguanglu/work/ros_study/create_msg_and_srv/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/wanguanglu/work/ros_study/create_msg_and_srv/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/wanguanglu/work/ros_study/create_msg_and_srv/install)
...
if(NOT "/home/wanguanglu/work/ros_study/create_msg_and_srv/devel/include " STREQUAL " ")
  set(beginner_tutorials_INCLUDE_DIRS "")
  set(_include_dirs "/home/wanguanglu/work/ros_study/create_msg_and_srv/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'wanguanglu <wanguanglu@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wanguanglu/work/ros_study/create_msg_and_srv/src/beginner_tutorials/${idir}'.  Ask the maintainer 'wanguanglu <wanguanglu@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/wanguanglu/work/ros_study/create_msg_and_srv/devel/lib;/home/wanguanglu/work/ros_study/create_msg_and_srv/devel/lib;/home/wanguanglu/work/create_msg_and_srv/devel/lib;/opt/ros/indigo/lib)
