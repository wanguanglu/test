...
typedef boost::shared_ptr<::beginner_tutorials::AddTwoIntsResponse>
    AddTwoIntsResponsePtr;
typedef boost::shared_ptr<::beginner_tutorials::AddTwoIntsResponse const>
...
struct IsFixedSize<
    ::beginner_tutorials::AddTwoIntsResponse_<ContainerAllocator>> : TrueType {
};
